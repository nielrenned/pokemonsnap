...
def main():
    ...
    symbols = {
        ...
        "gCanUseMask": (s["gCanUseMask"], "u32", "rw",
                        "bit0=apple, 1=pester, 2=flute, 3=dash, 4=sign detector, 5=L to stop, 6=technique scoring, 7=multiple scoring, 8=multiple scoring w/o technique (used when gCanUseOverride==0)"),
        "gCanUsePerLevelMask": (s["gCanUsePerLevelMask"], "u32[7]", "rw",
                        "[0]=Beach, [1]=Tunnel, [2]=Volcano, [3]=Cave, [4]=River, [5]=Valley, [6]=Rainbow. Bits within each u32 are the same as gCanUseMask. gCanUseMask takes priority."),
        ...
        "gCameraInversionYAMLOption": (s["gCameraInversionYAMLOption"], "u32", "rw", "0=inverted, 1=normal; applied only once on entering first course"),
